...
const Doctors = () => {
    ...
    return (
        <div className="h-full flex flex-col space-y-4">
            <div className="hidden md:flex flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                {specialties.map(specialty => (
                    <button
                        key={specialty}
                        onClick={() => setSelectedSpecialty(specialty)}
                        className={`px-4 py-2 rounded-lg whitespace-nowrap text-sm font-medium transition-all ${selectedSpecialty === specialty
                        ...
                        <div className="flex-1 overflow-y-auto space-y-2">
                            {filteredDoctors.map(doctor => (
                                <button
                                    ...
                                    className={`w-full text-left p-3 rounded-lg transition-all ${selectedDoctor?.id === doctor.id
                                    ...
                                    <div className="flex gap-3 items-start">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-1 mt-1 md:hidden">
                                                ...
                                                <span className="text-xs text-gray-400">{doctor.experience}y exp</span>
                                            </div>
                                        </div>
                                        <button
                                            onClick={(e) => {
                                            ...
                                            className="md:hidden bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold py-2 px-3 rounded-lg transition-colors flex-shrink-0"
                                        >
                                            Book
                                        </button>
                                    </div>
